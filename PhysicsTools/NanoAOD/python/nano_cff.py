...
nanoTableTaskCommon = cms.Task(
    ...
    jetPuppiTablesTask, jetAK8TablesTask,SSLTask,
    ...
    globalTablesTask, vertexTablesTask, metTablesTask, extraFlagsTableTask, SSLTablesTask,
...
def nanoAOD_addSSL(process):
    #process.nanoTableTaskCommon.add(process.SSLTask)
    #process.nanoTableTaskCommon.add(process.SSLTablesTask)
